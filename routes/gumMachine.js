...
var key = 'ABCSADSADsadsadsadad45241522';
...
var db = new Db('clouddb', server);

db.open(function(err, db) {
  db.authenticate("vipul","vipul123",function(err,success){
		if(!err) {
	        console.log("Connected to 'Vipuls Gumball shop' database");
